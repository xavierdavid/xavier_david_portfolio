...
class ArticleController extends AbstractController
{
    ...
    public function createArticle(Request $request, EntityManagerInterface $manager) {
        // Méthode qui créé un nouvel article - Injection de l'objet 'Request' et de l'objet 'EntityManagerInterface'
     ...
     */
    public function editArticle($id, Request $request, EntityManagerInterface $manager, FileUploader $fileUploader){
     ...
     */
    public function articleDelete($id, Request $request, EntityManagerInterface $manager){
     ...
     */
    public function commentDelete($id, Request $request, EntityManagerInterface $manager){
