...
class EducationController extends AbstractController
{
     ...
     */
    public function createEducation(Request $request, EntityManagerInterface $manager, FileUploader $fileUploader) {
        // Méthode qui créé une nouvelle formation - Injection de dépendance : objet 'Request', objet 'EntityManagerInterface' et service 'FileUploader'
     ...
     */
    public function editEducation($id, Request $request, EntityManagerInterface $manager, FileUploader $fileUploader){
     ...
     */
    public function educationDelete($id, Request $request, EntityManagerInterface $manager){
